...
- **v0.6 — planned:** authenticated, claims-scoped online corpus jobs and default-off corpus watchers will orchestrate the existing KE primitives with idempotency, retry/backpressure, provenance, and observable job state. Production ontology promotion, entity-resolution merge, and materialization remain human-governed.
