...
- **v0.6 — 计划：** 已认证、claims-scoped 的 online corpus job 与默认关闭的 corpus watcher 将以 idempotency、retry/backpressure、provenance 和可观测 job state 编排既有 KE 原语。production ontology promote、entity-resolution merge 和 materialization 仍由人工治理。
