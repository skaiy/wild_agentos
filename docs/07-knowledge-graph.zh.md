> *本文是 [07-knowledge-graph.md](07-knowledge-graph.md) 的中文版本。*
...
> 租户数据的可信作用域、命名与历史键状态以 [17-isolation-contract.zh.md](17-isolation-contract.zh.md) 为准。
...
历史键的迁移须另行设计，详见 [Isolation Contract](17-isolation-contract.zh.md)。
