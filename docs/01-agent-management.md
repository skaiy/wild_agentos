...
Domain-specific chat behavior belongs to an Agent-bound runtime asset or client, not core middleware; `ev-repair` is an optional example asset, not a middleware requirement.
